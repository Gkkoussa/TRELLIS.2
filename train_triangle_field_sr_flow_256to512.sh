#!/bin/bash
#SBATCH --job-name=trellis-trifield-sr256to512
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:4
...
export RUN_NAME="${RUN_NAME:-triangle_field_sr_flow_256to512_film_1m_${SLURM_JOB_ID}}"
export FLOW_CONFIG="${FLOW_CONFIG:-/home/gpranav/pranav_work/scratch/TRELLIS.2/configs/gen/triangle_field_sr_flow_256to512_film_f16c32_fp16_objxl4k_1m.json}"
