#!/bin/bash
#SBATCH --job-name=trellis-trifield-vae512-auxdrop
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:2
...
export RUN_NAME="${RUN_NAME:-triangle_field_vae_512_invarea_auxdrop_${SLURM_JOB_ID}}"
export FLOW_CONFIG="${FLOW_CONFIG:-/home/koussa/scratch/TRELLIS.2/configs/scvae/triangle_field_vae_next_dc_f16c32_fp16_512_ft_objxl4k_invarea_auxdrop.json}"
