#!/bin/bash
#SBATCH --job-name=trellis-lsr-ms-support
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:4
...
export FLOW_CONFIG="${FLOW_CONFIG:-$PWD/configs/gen/triangle_field_latent_sr_flow_allres_avgfrom512_rescond_noise025_trainable_decoder_multiscale_support_vae60k_f16c32_fp16_objxl4k.json}"
export RUN_NAME_PREFIX="${RUN_NAME_PREFIX:-triangle_field_latent_sr_flow_allres_avgfrom512_rescond_noise025_trainable_decoder_multiscale_support_vae60k}"
