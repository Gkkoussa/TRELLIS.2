#!/bin/bash
#SBATCH --job-name=trellis-gdist-flow-8gpu
#SBATCH --output=./job_logs/trellis-gdist-flow-8gpu_%j.log
#SBATCH --nodes=1
...
python train.py \
  --config configs/gen/slat_flow_michelangelo2gaussian_distance_dit_1_3B_256_bf16_8gpu_b16.json \
