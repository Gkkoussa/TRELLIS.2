#!/bin/bash
#SBATCH --job-name=trellis-gpatch-sparse-flow
#SBATCH --output=./job_logs/trellis-gpatch-sparse-flow_%j.log
#SBATCH --nodes=1
...
export RUN_NAME="${RUN_NAME:-gaussian_patch_sparse_flow_dit16_${SLURM_JOB_ID:-manual}}"
...
# Sparse support comes from GT active .vxz coords inside each 16^3 patch.
export CONFIG="${CONFIG:-configs/gen/gaussian_patch_sparse_flow_dit_16_1_3B_bf16.json}"
